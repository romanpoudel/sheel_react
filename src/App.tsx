  ...
  return (
    <>
      ...
      <section id="about-section">
        <div className="">
          <p className=" title-text-size text-purple-900">About Us</p>
        ...
        <div className="flex flex-row">
          <div className="lg:w-1/2 pb-10 lg:pb-0">
            <img src="../src/assets/dummy-img.jpg" alt="image"  className='w-96 h-96'/>
            <div className="lg:w-1/2">
              <p className="title-text-size text-purple-900">Quality and Intigrity</p>
              <p className="pt-5 text-justify content-text-size text-black ">Established in 2018, Sheel Waterproofing has been at
                the
                forefront
                of the waterproofing industry for over a decade. Founded by Mr. Shankar Karki, our company began with a
                vision
                to provide effective and reliable waterproofing solutions to protect properties from water damage. With a
                team
                of skilled professionals and a commitment to innovation, we have grown into a trusted name in the
                industry.
                Our
                journey continues as we strive to ensure dry and secure properties for all our valued clients.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id='cards' className='flex flex-around'>
        <CardWithoutImage
          cardTitle='10 +'
          cardContent='Years of Experience' />
        <CardWithoutImage
          cardTitle='500 +'
          cardContent='Project Completed' />
        <CardWithoutImage
          cardTitle='500 +'
          cardContent='Satisfied Clients' />
        <CardWithoutImage
          cardTitle='50 +'
          cardContent='Active Workers' />
      </section>

      <section id="services-section" className="w-full">
        <section className="px-8 py-20 lg:px-32 bg-white">
          <div className="pb-10">
            <p className="title-text-size text-purple-900">Our Services</p>
            <div className="custom__divider pb-4">
              <h1></h1>
            </div>
          </div>
      ...
      <section className="px-8 py-20 lg:px-32 grid grid-cols-12 bg-purple-900 p-4 ">
        <div className="col-span-12 lg:col-span-4">
          <figure>
            <img className="rounded-lg pb-10" src="../src/assets/dummy-img.jpg" alt="" />
          </figure>
        </div>
        <div className="col-span-12 lg:col-span-7 lg:col-start-6 text-white">
          <div className="rounded-lg ">
            <p className="title-text-size ">Words From Our CEO</p>
            <div className="custom__divider pb-4 ">
              <h1></h1>
            </div>
            <div className="text-justify content-text-size">
              <p>Dear Valued Customers, Welcome to Sheel Waterproofing, where excellence meets waterproofing expertise!
                As the CEO, I'm proud to lead a team dedicated to providing cutting-edge solutions for your waterproofing
                needs.
              </p>
              <br />
              <p>Our commitment to quality, innovation, and customer satisfaction is unmatched.
                Explore our website to discover how Sheel Waterproofing can protect your investments and ensure a watertight
                future for your projects.
              </p>
              <br />
              <p>Best regards,</p>
              <p>Shankar Karki</p>
              <p>CEO, Sheel Waterproofing Nepal Pvt. Ltd.</p>
            </div>
          </div>
        ...
        <div className="bg-slate-200 py-10">
          ...
          <div className="md:flex md:flex-row md:justify-center md:items-center gap-4  px-8 lg:px-32 ">
            ...
            <div className="md:w-1/2">
              ...
              <form id="contact-form" action="https://formspree.io/f/xrgneoqj" method="post" class="flex flex-col gap-4">
